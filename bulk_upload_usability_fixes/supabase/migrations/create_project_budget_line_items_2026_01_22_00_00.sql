-- B-V1-01C: Opret project_budget_line_items (baseline snapshot)
...
ALTER TABLE public.project_budget_line_items_2026_01_22_00_00 
ADD CONSTRAINT fk_project_budget_line_items_source_quote_line_item_id 
FOREIGN KEY (source_quote_line_item_id) REFERENCES public.project_quote_line_items_2026_01_16_23_00(id) ON DELETE SET NULL;

ALTER TABLE public.project_budget_line_items_2026_01_22_00_00 
ADD CONSTRAINT fk_project_budget_line_items_project_product_id 
FOREIGN KEY (project_product_id) REFERENCES public.project_products_2026_01_15_06_45(id) ON DELETE SET NULL;
...
COMMENT ON COLUMN public.project_budget_line_items_2026_01_22_00_00.source_quote_line_item_id IS 'Valgfri reference til kildetilbuds line item';
COMMENT ON COLUMN public.project_budget_line_items_2026_01_22_00_00.source_type IS 'Type: project_product eller custom';
COMMENT ON COLUMN public.project_budget_line_items_2026_01_22_00_00.project_product_id IS 'Reference til projektprodukt (hvis source_type = project_product)';
