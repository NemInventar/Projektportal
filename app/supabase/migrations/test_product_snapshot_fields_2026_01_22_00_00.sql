-- Test product snapshot-felter funktionalitet
...
BEGIN
    ...
    IF test_project_id IS NOT NULL THEN
        ...
        -- Test at JSON snapshot breakdown kan læses
        PERFORM 
        ...
        -- Test sammenligning mellem baseline og snapshot
        PERFORM 
            baseline_cost_total_per_unit,
            snapshot_cost_total_per_unit,
...
-- Verificer tabel struktur efter tilføjelse
SELECT 
    column_name,
    data_type,
    is_nullable,
